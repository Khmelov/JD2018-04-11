...
START TRANSACTION;
USE `rogov`;
INSERT INTO `rogov`.`labrary` (`ID`, `textFree`, `textPay`) VALUES (DEFAULT, 'some text', 'some text2');
...
START TRANSACTION;
USE `rogov`;
INSERT INTO `rogov`.`permission` (`ID`, `pemissionAccess`, `permissionUpdate`, `users_ID`, `labrary_ID`) VALUES (DEFAULT, 1, 0, 1, 1);
INSERT INTO `rogov`.`permission` (`ID`, `pemissionAccess`, `permissionUpdate`, `users_ID`, `labrary_ID`) VALUES (DEFAULT, 1, 1, 2, 1);
