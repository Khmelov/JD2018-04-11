...
public class RunnerTransform {
    ...
    public static void main(String[] args) {
        try {
            ...
            String xslFile = "src/by/it/zaleschonok/jd02_08/transform.xsl";
            Source xsl = new StreamSource(new File(xslFile));
            String input = "src/by/it/zaleschonok/jd02_07/Client.xml";
            Source xml = new StreamSource(new File(input));
            String output = "src/by/it/zaleschonok/jd02_08/Clients.html";
