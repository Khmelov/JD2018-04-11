package by.it.tayanovskii.jd03_01;
...
public class C_Init {
    ...
    public static void main(String[] args) {
        ...
        try (Connection connection =
            ...
            statement.executeUpdate("INSERT INTO `tayanovskii`.`users` (`id`, `login`, `password`, `email`, `roles_id`) VALUES (DEFAULT, 'user1', 'user1', 'user1@gmail.com', 2);");
            statement.executeUpdate("INSERT INTO `tayanovskii`.`users` (`id`, `login`, `password`, `email`, `roles_id`) VALUES (DEFAULT, 'user2', 'user2', 'user2@gmail.com', 2);");
            ...
            statement.executeUpdate("INSERT INTO `tayanovskii`.`permissions` (`id`, `access`, `users_id`, `publications_id`) VALUES (DEFAULT, true, 2, 2);");
            statement.executeUpdate("INSERT INTO `tayanovskii`.`permissions` (`id`, `access`, `users_id`, `publications_id`) VALUES (DEFAULT, false, 3, 1);");
            statement.executeUpdate("INSERT INTO `tayanovskii`.`permissions` (`id`, `access`, `users_id`, `publications_id`) VALUES (DEFAULT, false, 3, 2);");
