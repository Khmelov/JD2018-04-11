package by.it.akhmelev.project07.java.dao.resetdb;
...
public class C_Init{
    ...
    public static void main(String[] args) {
        try (
            ...
            statement.executeUpdate("INSERT INTO `akhmelev`.`users` (`id`, `login`, `password`, `email`, `roles_id`) VALUES (DEFAULT, 'admin', 'padmin', 'admin@it.by', 1);");
            statement.executeUpdate("INSERT INTO `akhmelev`.`users` (`id`, `login`, `password`, `email`, `roles_id`) VALUES (DEFAULT, 'users', 'puser', 'user@it.by', 2);");
            statement.executeUpdate("INSERT INTO `akhmelev`.`ads` (`id`, `description`, `flat`, `flats`, `rooms`, `area`, `price`, `address`, `users_id`) VALUES (DEFAULT, 'Test appartment', 1, 5, 2, 44, 66666, 'Minsk Lenina 1, app 1', 2);");
