...
public class RunnerTransform {
    ...
    private static String xslFile = "src/by/it/sharin/jd02_08/Transform.xsl";

    private static String input = "src/by/it/sharin/jd02_07/Persons.xml";

    private static String output = "src/by/it/sharin/jd02_08/Persons.html";
