package by.it.lanevich.jd02_02;
...
public class Market {
    ...
    public static void main(String[] args) {
        ...
        while (!Dispatcher.planComplete()) {
            ...
            Util.sleep(1000);
            if( (Math.ceil(BuyerQueue.getSizeQueue()/5)>countCasier) && countCasier<5){
                Thread thCasier = new Thread(new Cashier(++countCasier));
                thCasier.start();
                allThreads.add(thCasier);
