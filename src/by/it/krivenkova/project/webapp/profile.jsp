            ...
            <div class="form-group">
             ...
             <!-- Text input-->
              <div class="form-group">
                         ...
                         <!-- Text input-->
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="patronymic">Отчество</label>
                                        <div class="col-md-4">
                                            <input id="patronymic" name="patronymic" type="text" placeholder="" class="form-control input-md" required=""
                                                   value="${user.patronymic}">
                                            <span class="help-block">${help_patronymic}</span>
                                        </div>
                                    </div>
